...
<html>
<head>
<title>Worlds largest wedding planners website</title>
	...
	<div class="banner1" id="home1">
		<div class="container">
                    <div class="row">
                        ...
                        <a href="#"><i class="glyphicon glyphicon-user" style="color: white;font-size: 25px"></i><span></span></a>
                    </div>
			<div class="banner1-phone animated wow slideInLeft" data-wow-delay=".5s">
			...
			<div class="logo animated wow zoomIn" data-wow-delay=".5s">
                            <h1><a href="userhome.php" style="font-size: 40px;"><span></span>&nbsp;&nbsp;Dream Wedding</a></h1>
			</div>
			<div class="banner1-social animated wow slideInRight" data-wow-delay=".5s">
				<ul class="social-icons">
					...
					<li><a href="#" class="icon-button g-plus"><i class="icon-g-plus"></i><span></span></a></li>
                                        ...
                                        <h4 style="color: white">Welcome <?php echo $_SESSION['user_email'] ?></h4>
				</ul>
			</div>
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-14" id="link-effect-14">
							<ul class="nav navbar-nav">
                                                            <li class="active"><a href="userhome.php"><span>Home</span></a></li>
...
<div class="banner-bottom">
	...
	<div class="container">
		...
		<h1 class="animated wow zoomIn" data-wow-delay=".5s" align="center"><span>Browse Wedding Venues</span></h1>
		<br>
		<br>
		<div class="row">
			<div class="col-sm-3">
				<img src="images\Mumbai.jpg" alt=""><br><br>
				<h1 style="font-style: italic; text-align: center;">Mumbai</h1>
                                <br>
				<h2 style="font-style: italic; text-align: center;"><a href="Venues" style="color: #FF353B; font-weight: bolder;text-align: center;">Venues</a></h2>
			</div>
		</div>
	</div>
</div>
				...
				<div id="myTabContent" class="tab-content">
					...
					<div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
						<div class="tab_img">
							<div class="col-md-3 portfolio-grids">
								<a href="images/16.jpg" rel="title" class="b-link-stripe b-animate-go thickbox">
									<img src="images/16.jpg" class="img-responsive zoom-img" alt=""/>
									<div class="b-wrapper">
										<h5>Nuptials</h5>
										<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
									</div>
							...
							<div class="col-md-3 portfolio-grids">
								<a href="images/17.jpg" rel="title" class="b-link-stripe b-animate-go thickbox">
									<img src="images/17.jpg" class="img-responsive zoom-img" alt=""/>
									<div class="b-wrapper">
										<h5>Nuptials</h5>
										<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
									</div>
							...
							<div class="col-md-3 portfolio-grids">
								<a href="images/18.jpg" rel="title" class="b-link-stripe b-animate-go thickbox">
									<img src="images/18.jpg" class="img-responsive zoom-img" alt=""/>
									<div class="b-wrapper">
										<h5>Nuptials</h5>
										<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
									</div>
					...
					<div role="tabpanel" class="tab-pane fade" id="costumes" aria-labelledby="costumes-tab">
						<div class="tab_img">
							<div class="col-md-3 portfolio-grids">
								<a href="images/20.jpg" rel="title" class="b-link-stripe b-animate-go thickbox">
									<img src="images/20.jpg" class="img-responsive zoom-img" alt=""/>
									<div class="b-wrapper">
										<h5>Nuptials</h5>
										<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
									</div>
							...
							<div class="col-md-3 portfolio-grids">
								<a href="images/21.jpg" rel="title" class="b-link-stripe b-animate-go thickbox">
									<img src="images/21.jpg" class="img-responsive zoom-img" alt=""/>
									<div class="b-wrapper">
										<h5>Nuptials</h5>
										<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
									</div>
					...
					<div role="tabpanel" class="tab-pane fade" id="honeyMoon" aria-labelledby="honeyMoon-tab">
						<div class="tab_img">
							<div class="col-md-3 portfolio-grids">
								<a href="images/13.jpg" rel="title" class="b-link-stripe b-animate-go thickbox">
									<img src="images/13.jpg" class="img-responsive zoom-img" alt=""/>
									<div class="b-wrapper">
										<h5>Nuptials</h5>
										<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
									</div>
							...
							<div class="col-md-3 portfolio-grids">
								<a href="images/15.jpg" rel="title" class="b-link-stripe b-animate-go thickbox">
									<img src="images/15.jpg" class="img-responsive zoom-img" alt=""/>
									<div class="b-wrapper">
										<h5>Nuptials</h5>
										<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
									</div>
					...
					<div role="tabpanel" class="tab-pane fade" id="celebrations" aria-labelledby="celebrations-tab">
						<div class="tab_img">
							<div class="col-md-3 portfolio-grids">
								<a href="images/22.jpg" rel="title" class="b-link-stripe b-animate-go thickbox">
									<img src="images/22.jpg" class="img-responsive zoom-img" alt=""/>
									<div class="b-wrapper">
										<h5>Nuptials</h5>
										<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
									</div>
							...
							<div class="col-md-3 portfolio-grids">
								<a href="images/23.jpg" rel="title" class="b-link-stripe b-animate-go thickbox">
...
<!-- contact -->
	<!--<div class="contact" id="mail">
		<div class="container">
			<h3 class="animated wow zoomIn" data-wow-delay=".5s"><span>Contact Us</span></h3>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="footer-logo">
                            <a href="userhome.php" class="animated wow zoomIn" data-wow-delay=".5s">Dream Wedding</a>
