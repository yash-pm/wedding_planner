	...
	<div class="banner1" id="home1">
		<div class="container">
			...
			<div class="logo animated wow zoomIn" data-wow-delay=".5s">
				<h1><a href="index.html" style="font-size: 40px;"><span></span>&nbsp;&nbsp;Dream Wedding</a></h1>
			</div>
...
<div class="banner-bottom">
	<div class="change" id="log">
	<div class="container">
		<br>
		<h1 class="animated wow zoomIn" data-wow-delay=".5s" align="center"><span>CHANGE PASSWORD</span></h1>
		<div class="change-grids">
			<div class="col-md-3"></div>
				<div class="col-md-6 change-grid-center animated wow slideInCenter" data-wow-delay=".5s">
					<form action="change_password_source.php" method="post">
