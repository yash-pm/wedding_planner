...
<div class="banner-bottom">
	<div class="container">
            <h1 class="animated wow zoomIn" data-wow-delay=".5s" align="center" style="font-weight: bold; font-size: 50px"><span> Wedding Venues</span></h1>
		<br>
		<br>
                <div class="row">
                    <div class="col-md-4">
                        <img src="images/Jaipur.jpg" alt="" class="img-rounded"/>
                         <h1>Jaipur</h1>
                        <a href="Venues" style="color: #FF353B; font-weight: bolder;">Venues</a>
                    </div>
                    <div class="col-md-4">
                        <img src="images/Delhi.jpg" alt="" class="img-rounded"/>
                        <h1>Delhi</h1>
                        <a href="Venues" style="color: #FF353B; font-weight: bolder;">Venues</a>
                    </div>
                    <div class="col-md-4">
                        <img src="images/Surat.jpg" alt="" class="img-rounded"/>
                        <h1>Surat</h1>
                        <a href="Venues" style="color: #FF353B; font-weight: bolder;">Venues</a>
                    </div>
                </div>
