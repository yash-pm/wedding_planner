...
<body>
	...
	<!-- Login -->
<div class="forget" id="log">
	<div class="container">
		<br>
		<h1 class="animated wow zoomIn" data-wow-delay=".5s" align="center"><span>FORGET PASSWORD</span></h1>
		<div class="forget-grids">
			<div class="col-md-3"></div>
				<div class="col-md-6 forget-grid-center animated wow slideInCenter" data-wow-delay=".5s">
					<form action="forget_password_3_source.php" method="post">
                                            <label for="email">E-mail:</label><br>
                                            <input type="email" id="email" name="user_email" value="<?php echo $_SESSION['temp_user_email'] ?>" class="form-control"  readonly="readonly"><br>
                                            &nbsp;
                                            <label for="new_password">New Password:</label><br>
                                            <input type="password" id="new_password" name="new_user_password" required="required" class="form-control"><br>
                                            &nbsp;
                                            <label for="re_new_password">Re-New Password:</label><br>
                                            <input type="password" id="re_new_password" name="re_new_user_password" required="required" class="form-control"><br>
                                            &nbsp;
