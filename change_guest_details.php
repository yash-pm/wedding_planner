...
<?php
            ...
            if(isset($_REQUEST['gid']))
            {
                ...
                $get_guest_query = "SELECT * FROM `tbl_guest` WHERE `guest_id` = '$guest_id'";
                $get_guest_result = mysqli_query($conn, $get_guest_query);
                while($get_guest_row = mysqli_fetch_assoc($get_guest_result))
                {
                    $name = $get_guest_row['name'];
                    $address = $get_guest_row['address'];
                    $contact_no = $get_guest_row['contact_no'];
                    $email = $get_guest_row['email'];
                }
?>
<html>
    <head>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="col-md-6">
                ...
                <div class="panel-heading panel-style" id="panel1-head">Change Guest Details</div>
                <div class="panel-body" id="panel1-body" style="background-color: #ffe6eb">    
            
                <div class="form-group">
                    <form action="change_guest_details_source.php" method="post" onsubmit="return validation()">
                        <input type="hidden" name="guest_id" value="<?php echo $guest_id;?>">
                        <center><label for="guest_name" class="label_color">Name:</label></center>
                        <input type="text" id="guest_name" name="guest_name" class="form-control" value="<?php echo $name;?>">
                        <span id="name_error" class="text-danger"></span>
                        <br>                             
                                                                       
                       <center><label for="guest_address" class="label_color">Address:</label></center>
                        <textarea id="guest_address" name="guest_address" class="form-control" rows="5"><?php echo $address;?></textarea>
